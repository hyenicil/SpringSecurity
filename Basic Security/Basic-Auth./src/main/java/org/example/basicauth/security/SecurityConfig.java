package org.example.basicauth.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity security, HandlerMappingIntrospector introspector) throws Exception {
        ...
        //Sadece H2-console için geçerlidir.
        ...
        security
                ...
                .authorizeHttpRequests(x ->
                        ...
                        //Spring 3 ile and kalkmıştır
                )
                .formLogin(Customizer.withDefaults())//Login ve Logout sayfaları üretir..
                .httpBasic(Customizer.withDefaults())
                .sessionManagement(x -> x.sessionCreationPolicy(SessionCreationPolicy.IF_REQUIRED));
                //Oturum süresiyle alakalı kısım burası olmadan süre çalışmadı.
